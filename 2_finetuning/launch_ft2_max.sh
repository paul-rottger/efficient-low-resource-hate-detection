...
for dataset in has21_hi; do
    python finetune_and_test.py \
        ...
        --output_dir $DATA/low-resource-hate/finetuned-models/full-sample/multilingual-models/${basemodel}_${dataset}_2094_full \
        --overwrite_output_dir

    rm -rf $DATA/low-resource-hate/finetuned-models/full-sample/multilingual-models/${basemodel}_${dataset}_2094_full/check*
done