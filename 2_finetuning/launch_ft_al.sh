...
for dataset in bas19_es for19_pt ous19_fr ous19_ar san20_it; do
    for split in 10 20 30 40 50 100 200 300 400 500 1000 2000; do
        python finetune_and_test.py \
            ...
            --train_file $DATA/low-resource-hate/0_data/main/2_active_learning/${dataset}_*/train/train_${split}_al.csv \
            ...
            --output_dir $DATA/low-resource-hate/active-learning-models/${basemodel}_${dataset}_${split}_al \
